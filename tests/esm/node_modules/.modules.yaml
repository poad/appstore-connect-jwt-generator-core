...
hoistedDependencies:
  ...
  create-jest@29.7.0(@types/node@20.14.13):
    create-jest: private
  cross-spawn@7.0.3:
    cross-spawn: private
  debug@4.3.6:
  ...
  jest-circus@29.7.0:
    jest-circus: private
  jest-cli@29.7.0(@types/node@20.14.13):
    jest-cli: private
  jest-config@29.7.0(@types/node@20.14.13):
    jest-config: private
  jest-diff@29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 29 Jul 2024 11:14:23 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
